...
console.log("pr_datew",moment().format("YYYY"))
                ...
                }, function(err)
                {
                   ...
                   console.log("jaskkjsadc",employee_contribution_amount)
                      ...
                      ;
                        ...
                        var sghdata=await commonFunction.getQueryResults(sgh_query) 
                         ...
                         sgh_amountdeducation = (sgh_amountdeducation != undefined) ? sgh_amountdeducation : 0;
                         
                                         
                        result[index].shg_deucation= sgh_amountdeducation;
                       var finalnet=netSalaryFinal-sgh_amountdeducation;  
                        //  console.log('finalnet --->>>>>>>', netSalaryFinal + '-' + sgh_amountdeducation)
                       result[index].self_group_amount = sgh_amountdeducation; 
                        result[index].net_salary =finalnet; 
                   ...
                   // cpfInsertQuery = cpfInsertQuery.substring(0, cpfInsertQuery.length - 1);
                    ...
                    var column_header_end = ["Employer CPF", "Employee CPF", "Bonus", "Overtime", "Gross Salary", "Net Salary", "shg_deduction"];
                    ...
                    if (payslipData.length > 0) {
                        payslipData.forEach((employee, index) => {
                            ...
                            employeeData = employeeData.concat([employer_contribution, employee_contribution, bonus, overtime_allowance, gross_salary, net_salary, shg_deduction]);
