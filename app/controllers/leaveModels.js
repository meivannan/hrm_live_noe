    ...
    dashbordlist: (company_id) => {
        ...
        sql.query(leave_type, function (err, data) {
            if (err) {
                ...
                var permission_query = "select count(ld.emp_id) as count from hrm_leave_request as ld  inner join hrm_user_master as um on ld.emp_id=um.id where ld.leave_type='" + leave_type + "'  and um.role_id!=1 and um.company_id=" + company_id + " and from_date='"+normalutc+"'";
